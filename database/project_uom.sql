...
--
-- Host: localhost
-- Generation Time: Apr 04, 2018 at 12:33 PM
...
CREATE TABLE IF NOT EXISTS `student_detail_tbl` (
  ...
  PRIMARY KEY (`Std_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=13408 ;
...
(13406, 'K.K.S.H. Fernando', 'male', 72, 'Faculty of Engineering', 'Civil'),
(13407, 'P.D.F.K.Nimali', 'female', 875467433, 'University of Kelaniya', 'Information Tecnology');
